...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        for i in newGhostStates:
            ...
            if(min_ghost_distance<manhattanDistance(newPos,i)):
                min_ghost_distance=manhattanDistance(newPos,i)

        return min_ghost_distance+scared_times_sum+1/(min_distance)
